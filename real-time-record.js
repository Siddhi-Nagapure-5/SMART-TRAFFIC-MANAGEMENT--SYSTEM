...
// Stream video from browser(for safari also)
  navigator.mediaDevices.getUserMedia({
    ...
    // here it is actually performed wheen the camera or whicheveer deice you are using is properly set
...
// until this part nothing is done only the video streaming is started
// After this actual nmodel starts working and making predictions of the objects based on your data
...
//after gere the model will be fully loaded...
...
//If confidence is above 70%
        if (score > 70 && score < 100){
            ...
            highlighter.innerHTML = '<p>'+speed+ ' km/h ' + 'Vehicle'+'</p>';
